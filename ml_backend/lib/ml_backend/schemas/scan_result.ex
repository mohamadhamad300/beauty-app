defmodule MlBackend.Skin.ScanResult do
  use Ecto.Schema
  ...
  schema "scan_results" do
    ...
    has_many :acne_detections, MlBackend.Skin.AcneDetection
    has_many :skin_concerns, MlBackend.Skin.SkinConcern
    has_many :product_matches, MlBackend.Product.ScanProductMatch

defmodule MlBackend.Product.Product do
  use Ecto.Schema
  ...
  schema "products" do
    ...
    has_many :ingredients, MlBackend.Product.ProductIngredient
    has_many :shades, MlBackend.Product.ProductShade
    has_many :skin_concerns, MlBackend.Product.ProductSkinConcern

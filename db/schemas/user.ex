defmodule Glow.Accounts.User do
  use Ecto.Schema
  ...
  schema "users" do
    ...
    has_many :scan_results, Glow.Skin.ScanResult
    has_many :progress_entries, Glow.Skin.ProgressEntry
    has_many :bookings, Glow.Booking
    has_one :cart, Glow.Cart
    has_many :orders, Glow.Order
